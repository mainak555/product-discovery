...
| `server/static/server/js/home.js` | Home page only (`home.html`) | Chat UI interactions, chat session actions, SSE rendering, human-gate flow | Config-page form and integration setup behavior |
...
- `config.html`: `app.js`, `project_config.js`, `trello_config.js`
- `home.html`: `app.js`, `home.js`, `trello.js`
